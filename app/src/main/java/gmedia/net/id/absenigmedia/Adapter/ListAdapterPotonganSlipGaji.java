...
public class ListAdapterPotonganSlipGaji extends ArrayAdapter {
	private Context context;
	private List<ModelPotonganSlipGaji> list;

	public ListAdapterPotonganSlipGaji(Context context, List<ModelPotonganSlipGaji> list) {
		super(context, R.layout.view_lv_potongan_slip_gaji, list);
...
//            LayoutInflater inflater =(LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			...
			convertView = inflater.inflate(R.layout.view_lv_potongan_slip_gaji, null);
			holder.nama = (TextView) convertView.findViewById(R.id.txtNamaPotonganSlipGaji);
			holder.nominal = (TextView) convertView.findViewById(R.id.txtNominalPotonganSlipGaji);
			holder.garisTotal = (LinearLayout) convertView.findViewById(R.id.garisTotalPotongan);
			convertView.setTag(holder);
		} else {
			holder = (ViewHolder) convertView.getTag();
		}
		ModelPotonganSlipGaji model = list.get(position);
